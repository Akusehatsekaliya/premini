...
<body>
    <div id="app">
        <nav id="navbar" class="navbar fixed-top navbar-expand-lg navbar-dark border-bottom"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item @if(!Auth::check()) d-none @endif">
                            <a class="nav-link @if(Request::is('/')) active-menu @endif" href="/"><i
                                    class="bi bi-house-door"></i>Home</a>
                        </li>
                        <li class="nav-item @if(!Auth::check()) d-none @endif">
                            <a class="nav-link @if(Request::is('/daftarfilm')) active-menu @endif" href="#listFilm"><i
                                    class="bi bi-card-checklist"></i> List Film</a>
                        </li>
                        <li class="nav-item @if(!Auth::check()) d-none @endif">
                            @auth
                            <a class="nav-link @if(Request::is('history/*')) active-menu @endif"
                                href="{{ route('history', ['user_id' => Auth::id()]) }}">
