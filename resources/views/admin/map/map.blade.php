                ...
                <form action="{{ route('admintambah_map') }}" method="post">
                    ...
                    <div id="maps-container">
                        ...
                        <div class="form-group map-input">
                            ...
                            <input class="form-control" type="url" name="maps[]" placeholder="masukkan link">
                        </div>
                    </div>                  
                    <button type="button" id="add-map" class="btn btn-success mt-2">+</button>
                    <button type="button" id="remove-map" class="btn btn-danger mt-2">-</button>
...
<script>
  document.getElementById('add-map').addEventListener('click', function() {
      ...
      newInput.classList.add('form-group', 'map-input');
      newInput.innerHTML = `
          <label for="" class="form-label">Nama Lokasi</label>
  ...
  document.getElementById('remove-map').addEventListener('click', function() {
      var container = document.getElementById('maps-container');
      var inputs = container.getElementsByClassName('map-input');
      if (inputs.length > 1) {
